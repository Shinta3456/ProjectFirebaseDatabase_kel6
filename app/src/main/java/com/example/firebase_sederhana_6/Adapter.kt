...
class Adapter (val mCtx: Context, val layoutResId: Int, val list: List<Users> )
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val textInput = view.findViewById<TextView>(R.id.textWrite)
    ...
    private fun showUpdateDialog(user: Users) {
        ...
        val textInput = view.findViewById<EditText>(R.id.textWrite)

        textInput.setText(user.write)
        ...
        builder.setPositiveButton("Update") { dialog, which ->
            ...
            val write = textInput.text.toString().trim()
    ...
    private fun Deleteinfo(user: Users) {
        ...
        mydatabase.child(user.toString()).removeValue()
